(function() {
  ...
  htmlBase64img = function(data, base, opt) {
    return Q.Promise(function(resolve, reject) {
      if (opt.base64img) {
        data = data.replace(/<img\s([^>]*)src="([^"]+)"/i, function(full, extra, imgPath) {
  ...
  compileLess = function(file, opt) {
    return Q.Promise(function(resolve, reject) {
      ...
      lessStream.pipe(through.obj(function(file, enc, next) {
        return cssBase64img(file.contents.toString(), path.dirname(file.path), opt).then(function(content) {
  ...
  compileCss = function(file, opt) {
    return Q.Promise(function(resolve, reject) {
      ...
      content = opt.postcss ? opt.postcss(file) : file.contents.toString();
