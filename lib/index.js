(function() {
  var EOL, Q, fs, getIncProcessed, gutil, less, path, through;
  ...
  getIncProcessed = function(file, wrap) {
    return Q.Promise(function(resolve, reject) {
            ...
            return Q.Promise(function(resolve, reject) {
              return less.render(incFile.contents.toString('utf-8'), {
                ...
                if (err) {
                  ...
                  return resolve(['<style type="text/css">', css, '</style>'].join(EOL));
                }
              });
            });
          });
      ...
      return Q.all(asyncList).then(function(results) {
        ...
        results.forEach(function(res, i) {
          return content = content.replace('<INC_PROCESS_ASYNC_MARK_' + i + '>', res);
        });
        ...
        return resolve(content.join(EOL));
      }, function(err) {
        return reject(err);
      });
    });
  ...
  module.exports = function() {
    return through.obj(function(file, enc, next) {
      ...
      getIncProcessed(file).then((function(_this) {
        return function(processed) {
          var content;
          content = [
            "define(function(require, exports, module) {", "	function $encodeHtml(str) {", "		return (str + '').replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/\x60/g, '&#96;').replace(/\x27/g, '&#39;').replace(/\x22/g, '&quot;');", "	}", "	exports.render = function($data, $opt) {", "		$data = $data || {};", "		var _$out_= [];", "		var $print = function(str) {_$out_.push(str);};", "		_$out_.push('" + processed.replace(/<\/script>/ig, '</s<%=""%>cript>').replace(/\r\n|\n|\r/g, "\v").replace(/(?:^|%>).*?(?:<%|$)/g, function($0) {
