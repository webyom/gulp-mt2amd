(function() {
  var EOL, EXPORTS_REGEXP, Q, RIOT_EXT_REGEXP, beautify, compile, compileCss, compileLess, compileRiot, compileSass, cssBase64img, cssSprite, fixDefineParams, fs, getBodyDeps, getErrorStack, getUnixStylePath, gulpCssSprite, gutil, htmlBase64img, less, path, riot, sass, sus, through, uglify, _;
